                        ...
                        <div class="form-group">
                            ...
                            <div class="form-check-inline">
                                <label class="form-check-label mr-3">
                                    <input type="radio" class="form-check-input" name="slider" value="web" <?php if(@$slider=='web' || @$slider==''){ echo "checked"; } ?> >Web App
                                </label>
    ...
    <script>
        ...
        ?>
                ...
                file_list = {
                    'name': '<?php echo $image; ?>',
                    'size': '<?php echo $size; ?>',
                    'path': '<?php echo $url . "/assets/portfolioimage/" . $image; ?>'
                };
        <?php
            }
        }
        ...
        ?>
                    ...
                    file_list_first_section[<?php echo $key ?>] = {
                        'name': '<?php echo $value; ?>',
                        'size': '<?php echo $size; ?>',
                        'path': '<?php echo $url . "/assets/portfolioimage/" . $value; ?>'
                    };
        <?php
                }
            }
        ...
        ?>
                    ...
                    file_list_second_section[<?php echo $key ?>] = {
                        'name': '<?php echo $value; ?>',
                        'size': '<?php echo $size; ?>',
                        'path': '<?php echo $url . "/assets/portfolioimage/" . $value; ?>'
                    };
        ...
        ?>
                    ...
                    file_list_slider_section[<?php echo $key ?>] = {
                        'name': '<?php echo $value; ?>',
                        'size': '<?php echo $size; ?>',
                        'path': '<?php echo $url . "/assets/portfolioimage/" . $value; ?>'
                    };
