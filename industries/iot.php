...
<body>
    ...
    <section class="innerBanner">
        ...
        <div class="bannerMain industriesBanner">
            <img src="../assets/industriesImages/IOT.jpg" alt="Custom Application Development" title="Custom Application Development" class="img-fluid" />
                ...
                <div class="col-md-12">
                    <div class="thumbDesc">
                        <div class="innerThumbDesc ">
                            <img class="rightImage" src="../assets/domains/IOT.jpg" alt="image" />
                            <h2 class="py-2">IOT</h2>
                            ...
                            <h3 class="mt-3 py-2">Industrial Automation</h3>
                            ...
                            <h3 class="py-2">Connected Device</h3>
                            ...
                            <h3 class="py-2 mt-2">Smart/Wearable Device</h3>
