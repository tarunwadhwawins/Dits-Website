...
<body>
    ...
    <section class="innerBanner">
        ...
        <div class="bannerMain industriesBanner">
            <img src="../assets/industriesImages/Fintech.jpg" alt="Custom Application Development" title="Custom Application Development" class="img-fluid" />
                ...
                <div class="col-md-12">
                    <div class="thumbDesc">
                        <div class="innerThumbDesc">
                            <img class="rightImage" src="../assets/domains/fIn-tech.png" alt="image" />
                            <h2 class="py-2">Fintech Software Development</h2>
                            ...
                            <h3 class="py-2 mt-2">FinTech Development Services</h3>
