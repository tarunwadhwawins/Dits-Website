...
<section class="footerForm">
         <div class="container">
            ...
            <div class="row">
               ...
               <div class="col-sm-12">
                  <div class="footerInput">
                     <a href="#" class="btn btn-custom siteBtn">Submit</a>
                  </div>
               </div>
            </div>
         </div>
            ...
            <div class="row pb-70">
               <div class="col-lg-3 col-md-12 col-sm-12 col-xs-12">
                  <div class="widget widget-about">
                     ...
                     <p>We are one of the emerging software development companies in the IT sector, working with the view to encourage young talent and prefer knowledge and expertise over experience. We started our journey with developing customized software solutions.</p>
                  </div>
               </div>
